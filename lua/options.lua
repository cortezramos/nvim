...
-- Highlight más visible para selección visual (v, V, Ctrl+v)
vim.api.nvim_set_hl(0, "Visual", { bg = "#2d5a7b", bold = true })
vim.api.nvim_set_hl(0, "VisualNOS", { bg = "#2d5a7b", bold = true })
...
vim.opt.winbar = "%!v:lua.require('utils').get_winbar()"
